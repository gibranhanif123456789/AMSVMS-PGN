...
<body>
    ...
    <table class="info-table" style="margin-top: 20px;">
        ...
        <tr>
            <td>Perusahaan</td>
            <td>: <?php echo e($nda->user->perusahaan); ?></td>
        </tr>
        <tr>
            <td>Region</td>
            <td>: <?php echo e($nda->user->region); ?></td>
        </tr>
        <tr>
            <td>Bagian</td>
            <td>: <?php echo e($nda->user->bagian); ?></td>
        </tr>
    </table>

    <p>Adalah Pekerja dari PT/CV <?php echo e($nda->user->perusahaan); ?> yang berkedudukan di <?php echo e($nda->user->region); ?>, dimana saya
        ditugaskan
        dan ditempatkan di bagian <?php echo e($nda->user->bagian); ?>, sehubungan dengan penugasan saya tersebut, saya menyatakan
        bersedia untuk:</p>
    ...
    <p>Pernyataan ini tetap berlaku walaupun penugasan saya dari PT/CV <?php echo e($nda->perusahaan); ?> di PT PGAS Telekomunikasi
    ...
    <div style="margin-top: 40px;">
        <table style="width: 100%; text-align: center;">
            ...
            <tr>
                <td>
                    <img src="<?php echo e($nda->signature); ?>" alt="Tanda Tangan" style="width: 125px; height: auto;">
                </td>
                <td></td>
...
</html><?php /**PATH C:\laragon\www\Sourcekode\CODE-AMSVMS\resources\views\exports\ndaeksternalpdf.blade.php ENDPATH**/ ?>