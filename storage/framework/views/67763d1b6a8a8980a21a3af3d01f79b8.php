<?php $__env->startSection('title', 'Data Alatukur'); ?>
<?php $__env->startSection('page_title', 'Data Alatukur'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="table-column">
                ...
                <div class="table-responsive">
                    <table id="jenisTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $jenisalatukur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($item->nama_alatukur); ?></td>
                                    <td><?php echo e($item->kode_alatukur); ?></td>
                                    <td>
                                        <div class="action-buttons">
                                            <button class="btn btn-edit btn-sm mb-1"
                                                onclick="openModal('modalEditJenis<?php echo e($item->kode_alatukur); ?>')">
                                                <i class="fas fa-edit"></i> Edit
                                            </button>
                                            <button class="btn btn-delete btn-sm"
                                                onclick="confirmDelete('<?php echo e($item->kode_alatukur); ?>')">
                                                <i class="fas fa-trash-alt"></i> Hapus
                                            </button>

                                            <form id="delete-form-<?php echo e($item->kode_alatukur); ?>"
                                                action="<?php echo e(route('jenisalatukur.destroy', $item->kode_alatukur)); ?>"
                                ...
                                <div id="modalEditJenis<?php echo e($item->kode_alatukur); ?>" class="modal">
                                    <div class="modal-content">
                                        <span class="close"
                                            onclick="closeModal('modalEditJenis<?php echo e($item->kode_alatukur); ?>')">&times;</span>
                                        <h5>Edit Jenis Alatukur</h5>
                                        <form action="<?php echo e(route('jenisalatukur.update', $item->kode_alatukur)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="mb-3">
                                                <label>Nama Alatukur</label>
                                                <input type="text" name="nama_alatukur" class="form-control"
                                                    value="<?php echo e($item->nama_alatukur); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label>Kode Alatukur</label>
                                                <input type="text" name="kode_alatukur" class="form-control"
                                                    value="<?php echo e($item->kode_alatukur); ?>" readonly>
                                            </div>
            ...
            <div class="table-column">
                ...
                <div class="table-responsive">
                    <table id="brandTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $brandalatukur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <form id="delete-form-<?php echo e($item->kode_brand); ?>"
                                                action="<?php echo e(route('brandalatukur.destroy', $item->kode_brand)); ?>" method="POST"
                                                style="display: none;">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                            </form>
                                ...
                                <div id="modalEdit<?php echo e($item->kode_brand); ?>" class="modal">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?php echo e(route('brandalatukur.update', $item->kode_brand)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <div class="mb-3">
    ...
    <div id="modalTambahJenis" class="modal">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('jenisalatukur.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
    ...
    <div id="modalTambahBrand" class="modal">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('brandalatukur.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label>Nama Brand</label>
    ...
    <?php $__env->stopSection(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Sourcekode\CODE-AMSVMS\resources\views\menu\data\dataalatukur.blade.php ENDPATH**/ ?>