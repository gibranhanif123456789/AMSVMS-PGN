            ...
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo e($item->perangkat_ke); ?></td>
        ...
        <table style="width: 100%; margin-bottom: 60px; font-size: 12px; border: none;">
            <tr>
                <td style="text-align: left; border: none;">Dibuat:
                    <?php echo e(\Carbon\Carbon::now('Asia/Jakarta')->translatedFormat('j F Y H:i')); ?></td>
...
</html><?php /**PATH C:\laragon\www\Sourcekode\CODE-AMSVMS\resources\views\exports\perangkat.blade.php ENDPATH**/ ?>