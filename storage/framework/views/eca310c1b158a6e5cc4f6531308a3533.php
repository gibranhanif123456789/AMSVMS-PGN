<?php $__env->startSection('title', 'Pendaftaran DCAF'); ?>
<?php $__env->startSection('page_title', 'Pendaftaran DCAF'); ?>

<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('dcaf.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="main">
            <div class="section" style="margin-top: 20px;">
                <header class="header-profile">
                    <h2><?php echo e(__('Informasi NDA yang Berlaku')); ?></h2>
                    <p class="subtext">
                        <?php echo e(__('Jika Anda belum memiliki NDA yang aktif, pengajuan DCAF tidak dapat dilakukan. Silakan buat terlebih dahulu melalui menu NDA.')); ?>
                ...
                <div class="form-group">
                    <select name="nda_id" id="nda_id" class="form-control select2" required>
                        ...
                        <?php $__currentLoopData = $activeNdas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($nda->id); ?>">
                                NDA <?php echo e($nda->user->name); ?> - Berlaku s/d
                                <?php echo e(\Carbon\Carbon::parse($nda->masaberlaku)->translatedFormat('d M Y')); ?>
            ...
            <div class="section" style="margin-top: 20px;">
                <header class="header-profile">
                    <h2><?php echo e(__('Informasi Pemohon')); ?></h2>
                    <p class="subtext"><?php echo e(__('Mohon lengkapi data sesuai identitas Anda.')); ?></p>
                </header>
                ...
                <div class="form-group" style="width: 49.5%;">
                    ...
                    <input type="hidden" name="signature" id="signature" value="<?php echo e($dcaf->signature ?? ''); ?>">
                </div>
                            ...
                            <select name="no_rack" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $racks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($rack->no_rack); ?>">
                                        Rack <?php echo e($rack->no_rack); ?>, <?php echo e($rack->site->nama_site); ?> <?php echo e($rack->region->nama_region); ?>
            ...
            <div class="section" style="margin-bottom: 0px;">
                <header class="header-profile">
                    <h2><?php echo e(__('Informasi Pendataan Barang')); ?></h2>
                    <p class="subtext">
                        <?php echo e(__('Lengkapi data berikut untuk keperluan pencatatan barang masuk, keluar, dan perlengkapan yang dibawa.')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Sourcekode\CODE-AMSVMS\resources\views\VMS\user\pendaftarandcaf.blade.php ENDPATH**/ ?>