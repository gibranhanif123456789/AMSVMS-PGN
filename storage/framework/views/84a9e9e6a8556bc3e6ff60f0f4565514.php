...
<body>
  ...
  <table class="no-border">
    <tr>
      ...
      <td>: <?php echo e($dcaf->user->mobile_number); ?></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td>: <?php echo e($dcaf->pengawasDCAF->name ?? ''); ?></td>
      <td class="label">No Hp</td>
      <td>: <?php echo e($dcaf->pengawasDCAF->mobile_number ?? ''); ?></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td colspan="3">: <?php echo e($dcaf->user->bagian); ?></td>
    </tr>
    <tr>
  ...
  <table>
    ...
    <tbody>
      <?php $__currentLoopData = $dcaf->rekanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($index + 1); ?></td>
      <td><?php echo e($r->nama); ?></td>
      <td><?php echo e($r->perusahaan); ?></td>
      <td><?php echo e($r->ktp); ?></td>
      <td><?php echo e($r->telp); ?></td>
      </tr>
  ...
  <table class="no-border">
    <tr>
      ...
      <td>: <?php echo e($dcaf->tanggal_mulai); ?></td>
      <td class="label">Tanggal Selesai</td>
      <td>: <?php echo e($dcaf->tanggal_selesai); ?></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td>: <?php echo e($dcaf->waktu_mulai); ?></td>
      <td class="label">Waktu Selesai</td>
      <td>: <?php echo e($dcaf->waktu_selesai); ?></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td>: <?php echo e($dcaf->lokasi); ?></td>
      <td class="label">Nomor Rak</td>
      <td>: <?php echo e($dcaf->no_rack); ?></td>
    </tr>
    <tr>
      <td></td>
    ...
    <tr>
      ...
      <td>: <?php echo e($dcaf->jenis_pekerjaan); ?></td>
    ...
    <tr>
      ...
      <td colspan="3">: <?php echo e($dcaf->deskripsi_pekerjaan ?? ''); ?></td>
    </tr>
    <tr>
      <td></td>
  ...
  <table>
    ...
    <tbody>
      <?php $__currentLoopData = $dcaf->perlengkapans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($index + 1); ?></td>
  ...
  <table border="1" cellspacing="0" cellpadding="5">
    ...
    <tbody>
      <?php $__currentLoopData = $dcaf->barangMasuks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($index + 1); ?></td>
      <td><?php echo e($item['nama']); ?></td>
  ...
  <table border="1" cellspacing="0" cellpadding="5">
    ...
    <tbody>
      <?php $__currentLoopData = $dcaf->barangKeluars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($index + 1); ?></td>
      <td><?php echo e($item['nama']); ?></td>
      <td><?php echo e($item['berat']); ?></td>
    ...
    <table style="width: 70%; border-collapse: collapse; margin-bottom: 16px; margin-left: auto; margin-right: auto;">
      ...
      <tr>
        <td style="height: 70px; border: 1px solid #000; text-align: center; vertical-align: middle;">
          <?php if(isset($dcaf->signature) && !empty($dcaf->signature)): ?>
        <img src="<?php echo e($dcaf->signature); ?>" alt="Tanda Tangan Pemohon" style="max-width: 100%; max-height: 68px;">
      <?php endif; ?>
        </td>
        <td style="height: 70px; border: 1px solid #000; text-align: center; vertical-align: middle;">
          <?php if($dcaf->signedBy && $dcaf->signedBy->signature): ?>
        <img src="<?php echo e(base_path('storage/app/public/' . $dcaf->signedBy->signature)); ?>" alt="Tanda Tangan Penyetuju"
        style="max-width: 100%; max-height: 68px;">
      <?php endif; ?>
        </td>
      </tr>
      <tr>
        <td style="border: 1px solid #000; padding: 5px;">Tanggal : <?php echo e($dcaf->created_at); ?></td>
        <td style="border: 1px solid #000; padding: 5px;">
          <?php if($dcaf->signedBy): ?>
        Tanggal: <?php echo e($dcaf->updated_at); ?>

      </td>
    <?php endif; ?>
      </tr>
      <tr>
        <td style="border: 1px solid #000; padding: 5px;">Nama : <?php echo e($dcaf->user->name); ?></td>
        <td style="border: 1px solid #000; padding: 5px;">
          <?php if($dcaf->signedBy): ?>
        Nama : <?php echo e($dcaf->signedBy->name ?? ''); ?>
...
</html><?php /**PATH C:\laragon\www\Sourcekode\CODE-AMSVMS\resources\views\exports\dcaf.blade.php ENDPATH**/ ?>